...
void Sys_Follow_6_1(int callFrom)
{
...
void Sys_Follow_6_2_original(int callFrom)
{
...
void Sys_Follow_6_2(int callFrom)
{
...
//temporário
/*
void OrderManagement(int orderType)
{
    //Set_Market_Order_Trigger(FINAL_SHORT_VOLUME, FINAL_LONG_VOLUME );

    
    // quem vai determinar o tipo de ordem a ser executada é o algo
    switch(orderType) 
    {
        case 2:
            break;                                          
